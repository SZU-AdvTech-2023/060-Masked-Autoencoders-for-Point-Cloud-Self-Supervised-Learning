...
from models.rscnn_ssn_siamese_test import RSCNN_SSN_SIAMESE
...
def main():
    ...
    test_dataset_1 = KinectLQ_eval(num_points = args.num_points+2000, root = args.data_root, transforms=test_transforms
                                , valtxt='OC_val_du.txt', format="normal")
    ...
    test_dataset_2 = KinectLQ_eval(num_points = args.num_points+2000, root = args.data_root, transforms=test_transforms
                                , valtxt='TM_val_du.txt', format="normal")
    ...
    test_dataset_3 = KinectLQ_eval(num_points = args.num_points+2000, root = args.data_root, transforms=test_transforms
                                , valtxt='PS_val_du.txt', format="normal")
    ...
    test_dataset_4 = KinectLQ_eval(num_points = args.num_points+2000, root = args.data_root, transforms=test_transforms
                                , valtxt='FE_val_du.txt', format="normal")
    ...
    test_dataset_5 = KinectLQ_eval(num_points = args.num_points+2000, root = args.data_root, transforms=test_transforms
                                , valtxt='new_NU_val_du.txt', format="normal")
    ...
    with torch.no_grad():
        ...
        for j, data in enumerate(tqdm(test_dataloader_1)):
            ...
            for i in np.arange(0, results.shape[0]):
                if gallery_labels[results[i]] == probe_labels[i]:
                    correct_1 += 1
        print('Eval Set 1 total_samples:{} correct:{}'.format(samples,correct_1))      
        ...
        for j, data in enumerate(tqdm(test_dataloader_2)):
            ...
            for i in np.arange(0, results.shape[0]):
                if gallery_labels[results[i]] == probe_labels[i]:
                    correct_2 += 1
        print('Eval Set 2 total_samples:{} correct:{}'.format(samples,correct_2))      
        ...
        for j, data in enumerate(tqdm(test_dataloader_3)):
            ...
            for i in np.arange(0, results.shape[0]):
                if gallery_labels[results[i]] == probe_labels[i]:
                    correct_3 += 1
        print('Eval Set 3 total_samples:{} correct:{}'.format(samples,correct_3))      
        acc = float(correct_3/samples)
        print('\n test_dataset_3 {} acc: {:.6f}\n'.format(test_dataset_3.valtxt, acc))
        ...
        print('Eval Set 4 total_samples:{} correct:{}'.format(samples,correct_4))      
        acc = float(correct_4/samples)
        print('\n test_dataset_4 {} acc: {:.6f}\n'.format(test_dataset_4.valtxt, acc))
        ...
        for j, data in enumerate(tqdm(test_dataloader_5)):
            ...
            for i in np.arange(0, results.shape[0]):
                if gallery_labels[results[i]] == probe_labels[i]:
                    correct_5 += 1
        print('Eval Set 5 total_samples:{} correct:{}'.format(samples,correct_5))      
        acc = float(correct_5/samples)
        print('\n test_dataset_5 {} acc: {:.6f}\n'.format(test_dataset_5.valtxt, acc))
