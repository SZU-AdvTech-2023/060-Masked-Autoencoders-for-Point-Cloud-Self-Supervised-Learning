...
def run_net(args, config, train_writer=None, val_writer=None):
    ...
    train_dataset = KinectLQ_train_pair(num_points=4096, root="/data2/gaoziqi/PointFace/dataset", transforms=None, train=True,format="xyz")
    #train_dataset=Bosphorus(num_points=4096,root="/data2/gaoziqi/Point-MAE-main/data",transforms=None,train=True)
    #train_dataset = FRGC_train_pair(num_points=args.num_points, root=args.data_root, transforms=train_transforms, train=True)
    ...
    test_dataset = KinectLQ_eval(num_points = 4096, root ="/data2/gaoziqi/PointFace/dataset", transforms=None
                                 , valtxt='OC_val_du.txt', format="xyz")
    ...
    for epoch in range(start_epoch, config.max_epoch + 1):
        ...
        for idx, data in enumerate(train_dataloader):
            ...
            loss_gf = criterion_globfeat(features_A, features_B, target1, target2)
